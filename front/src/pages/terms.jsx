        ...
        <main className="page-container">
            <section className="page-hero">
                <div className="container">
                    ...
                    <p>يرجى قراءة شروط الاستخدام التالية بعناية قبل استخدام منصة "صادق".</p>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <h2>1. قبول الشروط</h2>
                            <p>
                                باستخدامك لمنصة "صادق"، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من الشروط، فلا يجوز لك استخدام الخدمة.
                            </p>

                            <h3>2. استخدام الخدمة</h3>
                            <p>
                                تم تصميم منصة "صادق" لمساعدتك على التحقق من مصداقية الأخبار والمعلومات. أنت توافق على استخدام الخدمة للأغراض المشروعة فقط وبما لا ينتهك حقوق الآخرين.
                            </p>
                            <ul>
                                <li>لا يجوز استخدام المنصة لنشر معلومات كاذبة أو مضللة بشكل متعمد.</li>
                                <li>يُمنع استخدام أي وسيلة آلية (bots) للوصول إلى الخدمة بشكل يؤثر على أدائها.</li>
                                <li>الخدمة مقدمة للاستخدام الشخصي وغير التجاري.</li>
                            </ul>

                            <h3>3. الملكية الفكرية</h3>
                            <p>
                                المحتوى الموجود على المنصة، بما في ذلك النصوص والرسومات والشعار، هو ملك لمنصة "صادق" ومحمي بموجب قوانين حقوق النشر والعلامات التجارية.
                            </p>
                            
                            <h3>4. إخلاء المسؤولية</h3>
                            <p>
                                تسعى منصة "صادق" لتقديم أعلى درجة من الدقة، ولكننا لا نضمن أن تكون جميع النتائج دقيقة بنسبة 100%. يتم توفير الخدمة "كما هي" ويجب استخدامها كأداة مساعدة وليس كحكم نهائي.
                            </p>
